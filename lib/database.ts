export type Product = {
  ...
  export const products: Product[] = [
    ...
    },
    {
      ...
      fit: "Slim Fit",
      colors: ["Black", "Blue", "Fuchsia Plaid", "Green Plaid", "Grey", "Light Grey", "Royal Blue Plaid", "Yellow"],
      sizes: ["S", "M", "L", "XL"],
      shippingInfo: [
    ...
    },
    {
      ...
      "fit": "Regular Fit",
      "colors": [
        "Black/Charcoal/White(five Pack)",
        "Black/White(five Pack)"
      ],
      "sizes": ["S", "M", "L", "XL"],
      "shippingInfo": [
